...
_Blog.switchDarkMode=function(){const currentTheme=document.cookie.replace(/(?:(?:^|.*;\s*)dark\s*\=\s*([^;]*).*$)|^.*$/,'$1')||'0';const isDark=currentTheme==='1'
document.body.classList.toggle('dark-theme',isDark)
var themeSwitcher=document.querySelectorAll('.theme-switch')||isDark
themeSwitcher.forEach(function(themeSwitcherItem){themeSwitcherItem.addEventListener('click',()=>{var currentTheme=document.cookie.replace(/(?:(?:^|.*;\s*)dark\s*=\s*([^;]*).*$)|^.*$/,'$1')||'0'
